...
urlpatterns = [
    ...
    path('get_tournament_info/<int:tournament_id>/', app.views.get_tournament_info, name="get_tournament_info"),
    path('make_tourney/<int:user_id>/', app.views.make_tourney, name="make_tourney"),
]
if settings.DEBUG:
