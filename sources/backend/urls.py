...
urlpatterns = [
    ...
    path('add_userS/', app.views.add_userS, name='add_userS'),
    path('remove_userS/', app.views.remove_userS, name='remove_userS'),
    ...
    path('get_user_by_id/<str:search_name>/', app.views.get_user_by_id, name='get_user_by_id'),
